...
//tavern view
@AndroidEntryPoint
class ThirteenthView : AppCompatActivity() {
    @Inject
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.thirteenthviewlayout)
        val session   = intent.getLongExtra(EXTRA_SESSION, -1L)

        val returnToMainMenuButton: ImageButton = findViewById(R.id.returnToMainMenuButton13)
