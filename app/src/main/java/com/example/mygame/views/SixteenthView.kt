...
//meal view
@AndroidEntryPoint
class SixteenthView : AppCompatActivity() {
    @Inject
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.sixteenthviewlayout)
        val session   = intent.getLongExtra(EXTRA_SESSION, -1L)

        val returnToMainMenuButton: ImageButton = findViewById(R.id.returnToMainMenuButton16)
