...
//Audience view
@AndroidEntryPoint
class NinthView : AppCompatActivity() {
    @Inject
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.ninthviewlayout)
        val session   = intent.getLongExtra(EXTRA_SESSION, -1L)

        val returnToMainMenuButton: ImageButton = findViewById(R.id.returnToMainMenuButton9)
