...
//view for lose
@AndroidEntryPoint
class EleventhView : AppCompatActivity() {
    @Inject
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.eleventhviewlayout)
        val session   = intent.getLongExtra(EXTRA_SESSION, -1L)

        val returnToMainMenuButton: ImageButton = findViewById(R.id.returnToMainMenuButton11)
